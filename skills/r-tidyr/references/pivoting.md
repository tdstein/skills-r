...
- Use `values_drop_na = TRUE` only when missing cells represent structural absence rather than meaningful missing observations.
...
- Use `values_fill` only for a justified structural default, not to hide missing measurements.
